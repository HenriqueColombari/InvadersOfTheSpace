...
public class SinglePlay2 extends javax.swing.JFrame {
            ...
            if(timerCancel){
                try{
                    ...
                    if(keyPressedCounter > 10){
                        lblA.setText("Score: SAVE THE WORLD FIRST");
                        lblD.setText("");
                        lblW.setText("");

                    }
                    if(remainingEnimies == 0){
                        lblClick.setText("THAT'S HOW YOU DO IT!!!");
                        lblA.setText("Score: 99999999");
                        lblD.setText("Click to go to menu!");
                        lblW.setText("The world, but most important, America,\n thanks you");
    ...
    private void initComponents() {
        ...
        lblClick.setText("You Know How to do it already");
        ...
        pnLayout.setHorizontalGroup(
            ...
            .addGroup(pnLayout.createSequentialGroup()
                ...
                .addGroup(pnLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblA, javax.swing.GroupLayout.PREFERRED_SIZE, 568, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblD, javax.swing.GroupLayout.PREFERRED_SIZE, 512, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblW, javax.swing.GroupLayout.PREFERRED_SIZE, 550, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(298, Short.MAX_VALUE))
            .addGroup(pnLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(pnLayout.createSequentialGroup()
                    .addGap(54, 54, 54)
                    .addComponent(lblClick, javax.swing.GroupLayout.PREFERRED_SIZE, 812, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void formKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_formKeyPressed
        ...
        if(evt.getKeyChar() == 'h'){
            String hack = JOptionPane.showInputDialog("VALKYRIE Protocol Inicialization");
            if(hack.equals("god bless america")){
                Timer massiveCaboom = new Timer();
                TimerTask taskMassiveCaboom = new TimerTask() {
                    @Override
                    public void run() {
                        png.DrawImageEnimies(iconExplosion, enimiesList);
                        enimiesList.clear();
                    }
                }; 
                new PlaySound().play("Bomb_Drop-__-447768269.wav");
                massiveCaboom.schedule(taskMassiveCaboom, 8000, 8000);  
            }
        }
    ...
    private void formMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_formMouseClicked
        ...
        if(clickCounter == 0){
            ...
            enimiesShoot.schedule(taskEnimiesShoot, 200, 600); 
            ...
            timerMove.schedule(taskMove, 200, 230);                                 
            startTimer(); 
        }   
        else if(clickCounter == -42){
            this.dispose();
            TelaInicio tl = new TelaInicio(false);
            tl.setVisible(true);
        }
        clickCounter ++;  
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SinglePlay2().setVisible(true);
