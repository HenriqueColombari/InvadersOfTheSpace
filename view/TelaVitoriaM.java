 ...
 * @author 826408
 */
public class TelaVitoriaM extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pn.add(btnSair);
        btnSair.setBounds(590, 260, 190, 40);
        ...
        btnSingleplayer.setBounds(590, 200, 190, 47);
        ...
        lblTitulo.setText("Victory");
        pn.add(lblTitulo);
        lblTitulo.setBounds(550, 90, 260, 90);

        lblImagemFundo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/vitória.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVitoriaM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaVitoriaM().setVisible(true);
            }
        });
    }
