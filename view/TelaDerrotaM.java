 ...
 * @author 826408
 */
public class TelaDerrotaM extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pn.add(lblTitulo);
        lblTitulo.setBounds(560, 190, 310, 90);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaDerrotaM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaDerrotaM().setVisible(true);
            }
        });
    }
