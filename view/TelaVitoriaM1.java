 ...
 * @author 826408
 */
public class TelaVitoriaM1 extends javax.swing.JFrame {

    PlaySound trilhaSonora1 = new PlaySound();
    PlaySound trilhaSonora2 = new PlaySound();
    Timer timerMusic = new Timer();
    TimerTask taskMusic = new TimerTask() {
        @Override
        public void run() {
            trilhaSonora2.play("VOLUME_You Win (Voice) - Sound Effect [HD].wav");
            trilhaSonora1.play("VOLUME_Victory sound effect.wav");
            this.cancel();
        }
    };
    public TelaVitoriaM1() {
    ...
    private void initComponents() {
        ...
        btnSingleplayer.setBounds(600, 390, 190, 47);

        lblTitulo.setBackground(new java.awt.Color(0, 204, 204));
        lblTitulo.setFont(new java.awt.Font("Tempus Sans ITC", 0, 80)); // NOI18N
        lblTitulo.setText(" They can't stop us together");
        pn.add(lblTitulo);
        lblTitulo.setBounds(260, 690, 1020, 90);

        lblImagemFundo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/multivictory.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVitoriaM1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaVitoriaM1().setVisible(true);
            }
        });
    }
