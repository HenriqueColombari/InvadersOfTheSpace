 ...
 * @author 826408
 */
public class TelaVitoria1 extends javax.swing.JFrame {
    ...
    TimerTask taskMusic = new TimerTask() {
        @Override
        public void run() {
            trilhaSonora2.play("VOLUME_Victory sound effect.wav");
            this.cancel();
        }
    };
    public TelaVitoria1() {
    ...
    private void initComponents() {
        ...
        pn.add(btnSair);
        btnSair.setBounds(570, 200, 190, 40);
        ...
        btnSingleplayer.setBounds(570, 130, 190, 47);
        ...
        lblTitulo.setText("You shall not pass");
        pn.add(lblTitulo);
        lblTitulo.setBounds(350, 10, 640, 100);

        lblImagemFundo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/YouShallNotPass.png"))); // NOI18N
    ...
    private void btnSingleplayerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSingleplayerActionPerformed
        // TODO add your handling code here:
            SinglePlay2 fp = new SinglePlay2();
            fp.setVisible(true);
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVitoria1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaVitoria1().setVisible(true);
            }
        });
    }
